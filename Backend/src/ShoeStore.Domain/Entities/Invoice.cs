...
public class Invoice : Entity<int>
{
    ...
    ///     This collection represents the individual items or products included in the invoice, along with their quantities
    ///     and unit prices.
    ///     Each InvoiceDetail entry corresponds to a specific product variant and its associated information, allowing for
    ///     detailed tracking of the items purchased in this invoice.
    /// </summary>
