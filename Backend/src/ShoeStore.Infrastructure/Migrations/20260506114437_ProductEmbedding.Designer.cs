...
namespace ShoeStore.Infrastructure.Migrations
{
    ...
    [Migration("20260506114437_ProductEmbedding")]
    partial class ProductEmbedding
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShoeStore.Domain.Entities.Embedding.ProductEmbedding", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_product_embedding");

                    b.HasIndex("Embedding")
                        .HasDatabaseName("ix_product_embedding_embedding");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("Embedding"), "hnsw");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("Embedding"), new[] { "vector_cosine_ops" });

                    b.HasIndex("ProductId")
                        .HasDatabaseName("ix_product_embedding_product_id");

                    b.ToTable("product_embedding", (string)null);
                });
            ...
            modelBuilder.Entity("ShoeStore.Domain.Entities.Embedding.ProductEmbedding", b =>
                {
                    b.HasOne("ShoeStore.Domain.Entities.Product", "Product")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_embedding_products_product_id");
