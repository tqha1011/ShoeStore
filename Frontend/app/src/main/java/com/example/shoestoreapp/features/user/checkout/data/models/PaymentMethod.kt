...
data class PaymentMethod(
    val id: String = "",
    val type: com.example.shoestoreapp.features.user.checkout.data.models.PaymentType = _root_ide_package_.com.example.shoestoreapp.features.user.checkout.data.models.PaymentType.VISA,
