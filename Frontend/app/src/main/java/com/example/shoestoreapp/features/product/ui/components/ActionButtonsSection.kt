 ...
 *
 * Chức năng:
 * - Hiển thị nút "ADD TO BAG" (thêm vào giỏ hàng)
 * - Hiển thị nút "FAVORITE" (đánh dấu yêu thích)
 * - Xử lý callback khi user click vào các nút
 *
...
fun ActionButtonsSection(
    ...
    // Column chứa 2 nút stack theo chiều dọc
    Column(
        modifier = modifier
            .fillMaxWidth()
            .padding(vertical = 16.dp)
    ) {
        // Nút "ADD TO BAG" - Button đen với text trắng
        Button(
            onClick = onAddToCartClick,
            modifier = Modifier
                .fillMaxWidth()
                .height(56.dp),
            shape = RoundedCornerShape(100.dp), // Bo tròn toàn bộ
        ...
        // Spacer: Tạo khoảng cách 12.dp
        Spacer(modifier = Modifier.height(12.dp))

        // Nút "FAVORITE" - Nút border với icon
        Row(
            modifier = Modifier
                .fillMaxWidth()
                .height(56.dp)
